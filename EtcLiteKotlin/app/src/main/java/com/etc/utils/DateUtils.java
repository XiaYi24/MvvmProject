...
/**
 * Created by Xia_燚 on 2018/10/26.
...
public class DateUtils {
    ...
    public static String currentTime() {
        return stamp2DateX(System.currentTimeMillis());
    }
     ...
     */
    public static String stamp2DateX(long s) {
        String res;
    ...
    public static String stamp2DateSystem(String s) {
        String res;
    ...
    public static String getCurrentTimeX() {
        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("HH:mm:ss");// HH:mm:ss
        Date date = new Date(System.currentTimeMillis());
        String time = simpleDateFormat.format(date);
        return time;
    ...
    public static String getDateWeek() {
        ...
        String localTime = dff.format(new Date());
    ...
    private static String Week(String dateTime) {
        String week = "";
