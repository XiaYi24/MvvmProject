package com.etc.logger

import android.text.TextUtils
import android.util.Log
import com.etc.logger.xlog.JsonLog
import com.etc.logger.xlog.XmlLog
import com.payc.xz.logger.xlog.BaseLog.printDefault
...
object KLog {
    ...
    private fun printFile(
       ...
       // val msg = contents[1]
        val headString = contents[2]
        printFile(tag, targetDirectory, fileName, headString)
    }
